...
class GlitchyPrice extends StatefulWidget {
  const GlitchyPrice({
    ...
    this.priceIncreaseColor = CustomColors.primary,
    this.priceDecreaseColor = CustomColors.primary,
    this.glitchDistance = 15,
...
class _GlitchyPriceState extends State<GlitchyPrice>
  ...
  Widget build(BuildContext context) {
    final currencyText = NumberFormat.simpleCurrency(
  ...
  Widget _buildLeftGlitchText(String currencyText) {
    return Positioned(
      left: -widget.glitchDistance * _controller.leftGlitchPercent,
      child: Text(
        currencyText,
  ...
  Widget _buildRightGlitchText(String currencyText) {
    return Positioned(
      left: widget.glitchDistance * _controller.rightGlitchPercent,
      child: Text(
        currencyText,
        style: widget.textStyle
            .copyWith(color: _controller.color.withOpacity(0.4)),
