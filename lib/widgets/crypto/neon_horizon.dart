...
class _NeonHorizonState extends State<NeonHorizon>
  ...
  void _onTick(Duration elapsedTime) {
    setState(() {
      _distancePercent = (elapsedTime.inMilliseconds /
...
class _NeonHorizonPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(
        Offset(centerX, 0), Offset(centerX, size.height), _linePaint);
    while (centerX - deltaX >= 0) {
      canvas.drawLine(Offset(centerX - deltaX, 0),
          Offset(centerX - (2.5 * deltaX), size.height), _linePaint);
      canvas.drawLine(Offset(centerX + deltaX, 0),
          Offset(centerX + (2.5 * deltaX), size.height), _linePaint);
    ...
    canvas.drawLine(
        Offset(0, firstLineY), Offset(size.width, firstLineY), _linePaint);
